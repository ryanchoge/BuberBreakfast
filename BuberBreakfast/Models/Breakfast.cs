...
namespace BuberBreakfast.Models;
    ...
    public class Breakfast
    {
        ...
        private Breakfast(Guid id, string name, string description, DateTime startDateTime, DateTime endDateTime, DateTime lastModifiedTime, List<string> savory, List<string> sweet)
        {
            Id = id;
            Name = name;
